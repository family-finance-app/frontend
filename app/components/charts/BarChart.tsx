...
const renderShape = (
  ...
  return (
    <rect
      ...
      className={cx(
        value >= 0
          ? 'fill-moss-400 dark:fill-moss-300'
          : 'fill-danger-400 dark:fill-danger-400'
      )}
      opacity={
    ...
    return (
      <div
        className={cx(
          ...
          // border color
          'border-gray-200 dark:border-background-100',
          // background color
        ...
        >
          <p
            className={cx(
              ...
              'font-medium',
              // text color
              'text-gray-900 dark:text-background-50'
            )}
          >
            {label}
          </p>
          ...
          {filteredPayload.map(
            (
              ...
              <ChartTooltipRow
                ...
                name={name}
                color={cx(value >= 0 ? 'bg-moss-400' : 'bg-danger-400')}
              />
            )
          )}
        </div>
        ...
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx(
                  'stroke-stack-400 stroke-1 dark:stroke-stack-400'
                )}
            ...
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-gray-800 text-sm font-medium dark:fill-background-100"
                >
                  {xAxisLabel}
                </Label>
              )}
            ...
            >
              {yAxisLabel && (
                <Label
                  ...
                  angle={-90}
                  offset={-15}
                  className="fill-gray-800 text-sm font-medium dark:fill-gray-100"
                >
                  {yAxisLabel}
                </Label>
              )}
...
export { BarChart, type BarChartEventProps, type ChartTooltipProps };
