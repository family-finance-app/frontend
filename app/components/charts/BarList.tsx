        ...
        {sortedData.map((item, index) => (
          ...
          >
            <div
              className={cx(
                // base
                'flex items-center rounded-sm transition-al',
                rowHeight,
                // background color
                'bg-kashmir-200 dark:bg-blue-900 hover:bg-kashmir-400',
                onValueChange
                ...
                {item.href ? (
                  ...
                  <p
                    className={cx(
                      ...
                      // text color
                      'text-background-800 text-m font-bold dark:text-gray-50'
                    )}
                  >
                    {item.name}
                  </p>
          ...
          >
            <p
              className={cx(
                ...
                // text color
                'text-background-800 font-bold dark:text-gray-50'
              )}
            >
