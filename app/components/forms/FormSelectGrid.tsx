...
import { getRemixIcon } from '@/utils';
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center space-x-3 flex-1">
                {Icon && (
                  <div className="w-10 h-10 sm:w-8 sm:h-8 bg-background-100  rounded-lg flex items-center justify-center">
                    {isRemixIcon ? (
                      <Icon className="w-5 h-5 sm:w-5 sm:h-5 text-primary-700 dark:text-primary-800" />
                    ) : (
