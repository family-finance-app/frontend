...
// calculates income change in absolute values per periods for dashboard stats section (example: +2000 vs last month); pervious period data is being calculated in getPreviousPeriodStats function
export default function calculateIncomeChange(
